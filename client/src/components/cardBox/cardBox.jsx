...
import { addBoxTypeGift, addProductGift, incBoxTypeGift, incProductGift, incPostCardGift, decBoxTypeGift, decProductGift, decPostCardGift } from '../../store/prefabricatedGiftSlice';
...
const CardBox = ({obj, type}) => {
    ...
    const handleAddItems = (findType, addAction, notificationMessage) => {
        setIsAdded(true);
        dispatch(addAction({ _id, photo, title, price, count: countProduct }));
