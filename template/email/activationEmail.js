...
export default function activationEmailHTML(link) {
                          ...
                          <table cellpadding="0" cellspacing="0" border="0" width="100%" em="atom">
                            <tr>
                              <td style="padding: 20px 0px 10px;" align="center">
                                <table cellpadding="0" cellspacing="0" border="0" width="283" style="width: 283px;">
                                  <tr>
                                    <td align="center" valign="middle" height="45" style="background-color: #f77452; border-radius: 100px; height: 45px;" bgcolor="#F77452">
                                      <a href="${link}" target="_blank" style="display: block; height: 45px; font-family: 'Arial Black', Gadget, sans-serif; color: #ffffff; font-size: 14px; line-height: 45px; text-decoration: none; white-space: nowrap;">АКТИВИРОВАТЬ АККАУНТ</a>
                                    </td>
                                  </tr>
                                </table>
                              </td>
